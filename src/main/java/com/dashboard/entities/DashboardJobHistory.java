...
public class DashboardJobHistory {
	...
	public DashboardJobHistory() {}
	
	public DashboardJobHistory(Long id, DashboardPersonal personal, String department, String division, Date startDate,
			Date endDate, long supervisor, String jobTitle, String jobCategory, String location, long departmentCode,
			long salaryType, String payPeriod, long hoursPerWeek, Boolean hazardousTraining) {
		super();
		this.id = id;
